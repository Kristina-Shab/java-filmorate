...
import ru.yandex.practicum.filmorate.dao.repository.BaseStorage;
...
import ru.yandex.practicum.filmorate.dao.repository.memory.InMemoryFilmStorage;
import ru.yandex.practicum.filmorate.dao.repository.memory.InMemoryUserStorage;
...
class FilmControllerTests {
    ...
    @BeforeEach
    void setUp() {
        BaseStorage<Film> filmStorage = new InMemoryFilmStorage();
        BaseStorage<User> userStorage = new InMemoryUserStorage();
